...
- Baseline config: `E:\GHuy\Study\Nhận dạng\SCRFD\insightface\detection\scrfd\configs\scrfd\scrfd_2.5g_80e_cosine_baseline.py`
- Improved config: `E:\GHuy\Study\Nhận dạng\SCRFD\insightface\detection\scrfd\configs\scrfd\scrfd_2.5g_80e_cosine_asr_jsar.py`
- Improved scale source: `{'source': 'train_log_mean', 'resolved_source': 'E:\\GHuy\\Study\\Nhận dạng\\SCRFD\\analysis_artifacts_bundle\\experiments\\asr_jsar\\work_dir\\adaptive_sr\\scale_prob_history.jsonl', 'num_records': 78, 'warmup_epochs_skipped': 2}`
...
| Baseline SR | 35.85 | 17.12 | 77.44 | 0.4754 | 0.2355 | 0.2153 | 0.0738 | 0.2228 | 0.1334 |
| ASR+JSAR | 29.98 | 15.09 | 63.68 | 0.5227 | 0.2347 | 0.1883 | 0.0543 | 0.1459 | 0.0808 |
